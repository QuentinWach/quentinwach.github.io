...
<!--
* [(2023.) Dubins Paths for Waveguide Routing](https://quentinwach.com/2023/11/01/dubins-paths-for-pics.html)
* (Super-secret project to be announced soon 😉...)
-->
...
I like to model, simulate, and visualize complex and chaotic physical systems both for work as well as a hobby and reached hundreds of thousands of views on Twitter and Reddit. 
...
<!--
I also created a [website to teach students how to create plots, programmatic visualizations and animations with Python for free](https://quentinwach.com/Animating-Science). 
-->
